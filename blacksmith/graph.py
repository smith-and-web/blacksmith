...
def build_unit(
    ...
    *,
    ...
    # Deterministic auto-fix in this unit's own clone before gating it — same fix-then-verify
    # order as the sequential path's auto_fix -> test_gate. Best-effort; never halts the unit.
    if fix is not None:
        try:
